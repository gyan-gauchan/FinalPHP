  ...
  <body data-spy="scroll" data-target=".onpage-navigation" data-offset="60">
    <main>
      ...
      <nav class="navbar navbar-custom navbar-fixed-top" role="navigation">
            ...
            <ul class="nav navbar-nav navbar-right">
              <li class="dropdown"><a class="dropdown-toggle" href="#" data-toggle="dropdown">Home</a>
                <ul class="dropdown-menu">
                  <li><a href="restapp.html">Return to homepage</a></li>
		...
		<?php
		$memPoints = 0;
		echo "You've earned $memPoints member points.  Order now to collect more!<br/>";
		?>
			  <form action="orderHistory.php" method="post">
			  <p><strong>Enter your email to view order history: </strong><br/>
			  <input name ="searchhist" type="text" size="55"></p>
