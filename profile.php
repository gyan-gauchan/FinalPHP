        ...
        <div class="container">
          ...
          <div class="collapse navbar-collapse" id="custom-collapse">
            <ul class="nav navbar-nav navbar-right">
			  ...
			  <li class="dropdown"><a class="dropdown-toggle" href="#" data-toggle="dropdown">OrderOnline</a>
                <ul class="dropdown-menu">
                  <li><a href="menudisplay.php">Place Your Order</a></li>
...
<h1>Welcome back <?php echo $firstName;?>! </h1>
	...
	<h3><ul class='options'>
    <li><a href = '#'>Change Payment Method</a></li>
	<li><a href = "changeEmail.html">Change Email</a></li>
	<li><a href = "changePass.html">Change Password</a></li>
	   ...
	   <footer class="footer bg-dark" >
          <div class="container">
            <div class="row">
              <div class="col-sm-6" >
              <p class="copyright font-alt">&copy; 2020&nbsp;<a href="index.html">Bootstrap: created by Titan-Master</a>, All Rights Reserved</p>
              </div>
              <div class="col-sm-6">
